        ...
        <table class="alt">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    echo "<tr><td>" . $row["disease_id"] . "</td><td><a href=' ddmoreaction.php/?id=" . $row["disease_id"] . "'>" . $row["disease_name"] . "</a></td><td>" . $row["doc_id"] . "</td><td>" . $row["contagious_property"] . "</td><td>" . $row["activity_date"] . "</td></tr>";
                }
            } else {
                echo "0 result";
            }
